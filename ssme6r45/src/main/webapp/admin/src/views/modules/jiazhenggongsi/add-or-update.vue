<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="服务项目" prop="fuwuxiangmu">
          <el-select v-model="ruleForm.fuwuxiangmu" placeholder="请选择服务项目">
            <el-option
                v-for="(item,index) in fuwuxiangmuOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="服务项目" prop="fuwuxiangmu">
	      <el-input v-model="ruleForm.fuwuxiangmu"
                placeholder="服务项目" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'" label="家政账号" prop="jiazhengzhanghao">
        ...
        <div v-else>
          <el-form-item class="input"v-if="ruleForm.jiazhengzhanghao" label="家政账号" prop="jiazhengzhanghao">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="服务内容" prop="fuwuneirong">
          <el-input v-model="ruleForm.fuwuneirong" 
              placeholder="服务内容" clearable  :readonly="ro.fuwuneirong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="服务内容" prop="fuwuneirong">
              <el-input v-model="ruleForm.fuwuneirong" 
                placeholder="服务内容" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
      ...
      this.$http({
		...
		if(json.lianxidianhua!=''&&json.lianxidianhua){
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/fuwuxiangmu/fenlei`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
                this.fuwuxiangmuOptions = data.data;
              } else {
                this.$message.error(data.msg);
              }
            });
            ...
            this.$http({
              url: `option/guanliayi/jiazhengzhanghao`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
    ...
    jiazhengzhanghaoChange () {
      this.$http({
        url: `follow/guanliayi/jiazhengzhanghao?columnValue=`+ this.ruleForm.jiazhengzhanghao,
        method: "get"
      }).then(({ data }) => {
        if (data && data.code === 0) {
