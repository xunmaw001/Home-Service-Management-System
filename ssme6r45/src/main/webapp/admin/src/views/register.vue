  ...
  <div>
    <div class="container">
      <div class="login-form" style="backgroundColor:rgba(255, 255, 255, 0.17);borderRadius:10px">
        <h1 class="h1" style="color:rgba(36, 194, 205, 1);fontSize:28px;">家政服务管理系统小程序注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm" label-width="120px">
			...
			<!-- <div v-if="tableName=='jiazhengayi'" class="input-group">
			   <div class="label">家政账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.jiazhengzhanghao" class="input" type="text" placeholder="家政账号">
			   </div>
			 </div> -->
			<el-form-item label="家政账号" class="input" v-if="tableName=='jiazhengayi'">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='jiazhengayi'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<!-- <div v-if="tableName=='jiazhengayi'" class="input-group">
			...
			<el-form-item label="家政姓名" class="input" v-if="tableName=='jiazhengayi'">
			...
			<el-form-item label="年龄" class="input" v-if="tableName=='jiazhengayi'">
			...
			<el-form-item label="手机" class="input" v-if="tableName=='jiazhengayi'">
			  <el-input v-model="ruleForm.shouji" autocomplete="off" placeholder="手机"  />
			</el-form-item>
